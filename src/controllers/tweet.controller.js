...
const updateTweet = asyncHandler(async (req, res) => {
    try {
        ...
        throw new ApiError(401,error?.message || "Something went wrong while updating the tweet")
    }
})
...
const deleteTweet = asyncHandler(async (req, res) => {
   try {
    ...
    throw new ApiError(500, error?.message || "Something went wrong while deleting the tweet")
   }
})
